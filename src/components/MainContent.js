...
export const MainContent = () => {
  ...
  const renderFeatureCard = (feature, alignment = "center") => {
    ...
    return (
      <div className={`bg-card/60 backdrop-blur-md border border-border/60 rounded-2xl p-8 md:p-10 transition-all duration-300 hover:bg-card/80 shadow-[0_12px_40px_-12px_rgba(15,30,50,0.35)] flex flex-col gap-4 ${alignmentClasses}`}>
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <section id="features" className="mt-24">
          ...
          <div className="relative mt-16 max-w-5xl mx-auto">
            <div className="hidden md:block absolute inset-y-4 left-1/2 -translate-x-1/2 w-[2px] bg-gradient-to-b from-yellow-300 via-orange-300 to-purple-400 opacity-60"></div>
                  ...
                  <div key={feature.title} className="relative">
                    ...
                    <div className="hidden md:grid md:grid-cols-[1fr_auto_1fr] md:items-center md:gap-10">
                      ...
                      <div className="hidden md:flex flex-col items-center">
                        <span className="w-4 h-4 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 border-4 border-white shadow-lg"></span>
        ...
        <section id="about" className="mt-24 max-w-4xl mx-auto text-center md:text-left">
          <div className="bg-card/60 backdrop-blur-xl border border-border/60 rounded-3xl p-10 md:p-14 shadow-[0_24px_60px_-20px_rgba(15,30,50,0.35)]">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10 text-left">
              <div className="bg-white/10 border border-white/20 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-foreground">Holistic</h3>
                <p className="text-muted-foreground text-sm mt-2">Structured check-ins, creative therapy, and community spaces aligned to your goals.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-foreground">Personalized</h3>
                <p className="text-muted-foreground text-sm mt-2">Smart recommendations adapt to your mood trends and preferences.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-foreground">Secure</h3>
                <p className="text-muted-foreground text-sm mt-2">Your reflections stay private, encrypted, and under your control.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="mt-8 space-y-3 text-muted-foreground">
                  ...
                  <p><span className="text-foreground font-medium">Community:</span> Join the Aspira Lounge on Discord</p>
                </div>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-2xl p-8">
                ...
                <form className="space-y-4">
                  ...
                  />
                  <button type="button" className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-medium py-3 rounded-xl hover:opacity-90 transition-all duration-200">
                    Subscribe
                  </button>
                </form>
              </div>
        ...
        <footer className="mt-24">
          <div className="max-w-6xl mx-auto bg-card/60 backdrop-blur-xl border border-border/60 rounded-3xl px-8 py-12 shadow-[0_24px_60px_-20px_rgba(15,30,50,0.35)]">
